...
function paths(name: IconName): JSX.Element {
  switch (name) {
    ...
    case 'einstellungen':
      // Proper toothed gear (Zahnrad): outer cog outline + inner hub circle.
      return (
        <g>
          <path d="M19.4 12c0-.47-.04-.92-.12-1.36l2.06-1.5-2-3.46-2.36 1a7.3 7.3 0 0 0-2.36-1.37L14.3 2.8h-4l-.32 2.51A7.3 7.3 0 0 0 7.62 6.7l-2.36-1-2 3.46 2.06 1.5c-.08.44-.12.89-.12 1.36s.04.92.12 1.36l-2.06 1.5 2 3.46 2.36-1c.7.59 1.5 1.06 2.36 1.37l.32 2.51h4l.32-2.51a7.3 7.3 0 0 0 2.36-1.37l2.36 1 2-3.46-2.06-1.5c.08-.44.12-.89.12-1.36Z" />
